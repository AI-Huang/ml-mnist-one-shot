...
Experiment code on training a MNIST classifier with only 10 samples. See my blog post (in Chinese) [mnist-one-shot](https://borgwang.github.io/dl/2019/11/29/mnist-one-shot.html).
